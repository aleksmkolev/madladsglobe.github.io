...
(function () {
    ...
    setInterval(function () {
        ...
        globe.plugins.objects.add(25.30,42.45, {
            imagesrc: "images/madlads.jpg",
            imageheight: 33,
            imagewidth: 50
        });
        globe.plugins.objects.add(2.2137,46.2276, {
            imagesrc: "images/french.jpg",
            imageheight: 33,
            imagewidth: 50
        });
        globe.plugins.objects.add(5.2913,52.1326, {
            imagesrc: "images/dutch.jpg",
            imageheight: 33,
            imagewidth: 50
        });
        // add india flag
